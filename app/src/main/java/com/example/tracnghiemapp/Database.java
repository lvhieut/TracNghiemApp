...
public class Database extends SQLiteOpenHelper {
    ...
    //chèn câu hỏi và câu trả lời vào đáp án csdl
    ...
    private void CreateQuestions(){
        ...
        insertQuestion(q11);
        Question q12 = new Question(" Cầu vượt biển dài nhất Việt Nam ở đâu?",
                "A. Cầu Thị Nại",
                "B. Cầu Tân Vũ - Lạch Huyện",
                "C. Cầu Mỹ Thuận",
                "D. Cầu Chương Dương", 2, 3);
        insertQuestion(q12);

        Question q13 = new Question("Trong câu “Thưa ông, chúng cháu ở Gia Lâm lên đấy ạ. Đi bốn năm hôm mới lên đến đây, vất vả quá!”. Câu nói “Thưa ông” thuộc thành phần gì của câu?",
                " A. Phụ chú", " B. Cảm thán", "C. Gọi đáp","D. Tình thái", 3, 1);
        insertQuestion(q13);

        Question q14 = new Question("Đỉnh núi Pan-xi-păng có độ cao bao nhiêu mét?",
                "a. 3134 mét.",
                "b. 3143 mét.",
                "c. 3314 mét.",
                "d. 1 mét 2", 2, 3);
